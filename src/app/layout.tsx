...
export const metadata: Metadata = {
  title: "Indian Supplies — Wholesale Ordering Portal",
  description:
    "Browse the full Indian Supplies wholesale catalogue, build your order, and arrange delivery to your business.",
};
